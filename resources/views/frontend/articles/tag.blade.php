    ...
    <div class="bg-white rounded-lg shadow-sm p-8 my-8">
        <div class="text-center">
            ...
            <div class="mt-4 text-sm text-gray-500">
                {{ $articles->total() }} {{ Str::plural('article', $articles->total()) }} tagged with "{{ $tag->name }}"
            </div>
        </div>
    </div>
        ...
        <div class="lg:w-2/3">
            ...
            @else
                ...
                <div class="text-center py-12 bg-white rounded-lg shadow-sm">
                    ...
                    <p class="text-gray-600">There are currently no published articles tagged with "#{{ $tag->name }}".</p>
                    <div class="mt-6">
