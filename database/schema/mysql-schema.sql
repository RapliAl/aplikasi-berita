...
CREATE TABLE `article_views` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `article_views_user_id_article_id_unique` (`user_id`,`article_id`),
  ...
  CONSTRAINT `article_views_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
